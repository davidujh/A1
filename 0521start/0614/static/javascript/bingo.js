...
function bingoChack(){
    ...
    bingo[idx]=0;//해단 td위치와 같은 bingo배열에 0으로 변경
...
function start(){
    $(".num").click(bingoChack); // 숫자가 표시된 td를 클릭하면 ...
    //빙고 게임을 위한 숫자배치
    //빙고 시작 버튼 감추기
    //빙고 진행 상황 보이기
...
function drow(){//배열의 값 테이블(td)에 출력
    var td = $(".num");
